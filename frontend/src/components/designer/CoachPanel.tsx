...
export default function CoachPanel({ coach, loading, error, onRequest }: Props) {
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        <Button onClick={onRequest} disabled={loading} className="w-full" variant="secondary">
          {loading ? '코치가 분석 중…' : 'AI 코치에게 평가받기'}
        </Button>
        ...
        {coach && !loading && (
          <div className="space-y-3">
            <div className="flex items-center gap-3 rounded-lg bg-violet-50 p-3">
              ...
              <div>
                <div className="text-xs text-violet-500">설계 점수</div>
